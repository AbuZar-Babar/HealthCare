...
extension SpecialtyThemeColors on ThemeData {
  ...
  Map<String, Color> get specialtyColors => AppColors.specialtyColors;

  // Convenience method to get a specialty color by name
  Color getSpecialtyColor(String specialty) =>
      AppColors.getSpecialtyColor(specialty);

  // Individual specialty colors for direct access
  Color get cardiologyColor => AppColors.specialtyColors['Cardiology']!;
  Color get neurologyColor => AppColors.specialtyColors['Neurology']!;
  Color get dermatologyColor => AppColors.specialtyColors['Dermatology']!;
  Color get orthopedicsColor => AppColors.specialtyColors['Orthopedics']!;
  Color get pediatricsColor => AppColors.specialtyColors['Pediatrics']!;
  Color get generalColor => AppColors.specialtyColors['General']!;
